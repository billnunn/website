...
Knowing a piece of mathematics without knowing (at least) a sketch of a proof can be dangerous, as I found out recently when requiring a *very* slight generalisation of Lemma 1. I needed to understand the following:
...
**Closing Thoughts**: Every modern mathematician uses results they don't know how to prove, and it would be extremist to recommend only using a result if you know at least a sketch of its proof. I do think we should all try to know when a result is only memorised however, and in the case of simple results like fact (1), remedy that state before embarrassment may ensue.

The same sort of discussion doesn't just apply to mathematical results, but also to other things, like our opinions!
